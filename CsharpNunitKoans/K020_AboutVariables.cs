...
namespace TheKoans
{
	...
	public class K020_AboutVariables : KoanHelper
	{
		...
		public void ImplicitAssignment ()
		{
			...
			var name = "John";
			Assert.AreEqual (typeof(var), name.GetType (), "Identify the data type of the value John to proceed on your Karma quest.");
		...
		public void ImplicitArrayAssignmentWithSameTypes ()
		{
			...
			Assert.AreEqual (typeof(var), names.GetType (), "Determine the type of the array elements to improve your Karma.");
		...
		public void MultipleAssignmentsOnSingleLine ()
		{
			...
			Assert.AreEqual (string, firstName, "Explicit type assignment should not impact the value.");
			Assert.AreEqual (string, lastName, "Implicit type assignment should also not impact the value (although lastName was explicitly set).");
		}
		...
		public void ImplicitAssignmentBasedOnAnotherVariable ()
		{
			...
			Assert.AreEqual (typeof(var), myNum.GetType (), "The apple does not fall far from the tree.  Neither does the type of the long variable you pulled the value from.");
		...
		public void ImplicitAssignmentBasedOnExpressionResults ()
		{
			...
			Assert.AreEqual (typeof(var), myTotal.GetType (), "An int and a long walk into a bar... And their baby is a...");
		}
		...
		public void ExplicitAssignmentByCasting ()
		{
			...
			Assert.AreEqual (typeof(var), canDoThis.GetType (), "Do not be short on patience. Your path to enlightenment is a process, not a destination.");
			Assert.AreEqual (92286L, canDoThis, "Notice how the information is changed/lost in the conversion. This is why the compiler cannot implicitly do it.");
		}
